...
public class PrometheusHandler : IMetricsHandler
{
	...
	public void ProcessHumditiy(AmbientWeatherMetricsPostRequest metrics)
	{
		if (metrics.Humidity.HasValue)
		{
			AmbientWeatherPrometheusMetrics
				.Humidity
				.WithLabels("outdoor", metrics.Mac ?? "none", metrics.StationType ?? "none")
		...
		if (metrics.HumidityIn.HasValue)
		{
			AmbientWeatherPrometheusMetrics
				.Humidity
				.WithLabels("indoor", metrics.Mac ?? "none", metrics.StationType ?? "none")
	...
	public void ProcessLowBattery(AmbientWeatherMetricsPostRequest metrics)
	{
		...
		if (metrics.Batt_Co2.HasValue)
		{
			AmbientWeatherPrometheusMetrics
				.LowBattery
				.WithLabels("co2", metrics.Mac ?? "none", metrics.StationType ?? "none")
	...
	public void ProcessRain(AmbientWeatherMetricsPostRequest metrics)
	{
		if (metrics.EventRainIn.HasValue)
		{
			AmbientWeatherPrometheusMetrics
				.Rain
				.WithLabels("event", metrics.Mac ?? "none", metrics.StationType ?? "none")
		...
		if (metrics.HourlyRainIn.HasValue)
		{
			AmbientWeatherPrometheusMetrics
				.Rain
				.WithLabels("hourly", metrics.Mac ?? "none", metrics.StationType ?? "none")
		...
		if (metrics.DailyRainIn.HasValue)
		{
			AmbientWeatherPrometheusMetrics
				.Rain
				.WithLabels("daily", metrics.Mac ?? "none", metrics.StationType ?? "none")
		...
		if (metrics.WeeklyRainIn.HasValue)
		{
			AmbientWeatherPrometheusMetrics
				.Rain
				.WithLabels("weekly", metrics.Mac ?? "none", metrics.StationType ?? "none")
		...
		if (metrics.MonthlyRainIn.HasValue)
		{
			AmbientWeatherPrometheusMetrics
				.Rain
				.WithLabels("monthly", metrics.Mac ?? "none", metrics.StationType ?? "none")
		...
		if (metrics.YearlyRainIn.HasValue)
		{
			AmbientWeatherPrometheusMetrics
				.Rain
				.WithLabels("yearly", metrics.Mac ?? "none", metrics.StationType ?? "none")
	...
	public void ProcessSolarRadiation(AmbientWeatherMetricsPostRequest metrics)
	{
		if (metrics.SolarRadiation.HasValue)
		{
			AmbientWeatherPrometheusMetrics
				.SolarRadiation
				.WithLabels("solarradiation", metrics.Mac ?? "none", metrics.StationType ?? "none")
	...
	public void ProcessTemperature(AmbientWeatherMetricsPostRequest metrics)
	{
		...
		if (metrics.Temp1F.HasValue)
		{
			AmbientWeatherPrometheusMetrics
				.Temperature
				.WithLabels("temp1", metrics.Mac ?? "none", metrics.StationType ?? "none")
		...
		if (metrics.Temp2F.HasValue)
		{
			AmbientWeatherPrometheusMetrics
				.Temperature
				.WithLabels("temp2", metrics.Mac ?? "none", metrics.StationType ?? "none")
		...
		if (metrics.Temp3F.HasValue)
		{
			AmbientWeatherPrometheusMetrics
				.Temperature
				.WithLabels("temp3", metrics.Mac ?? "none", metrics.StationType ?? "none")
		...
		if (metrics.Temp4F.HasValue)
		{
			AmbientWeatherPrometheusMetrics
				.Temperature
				.WithLabels("temp4", metrics.Mac ?? "none", metrics.StationType ?? "none")
		...
		if (metrics.Temp5F.HasValue)
		{
			AmbientWeatherPrometheusMetrics
				.Temperature
				.WithLabels("temp5", metrics.Mac ?? "none", metrics.StationType ?? "none")
		...
		if (metrics.Temp6F.HasValue)
		{
			AmbientWeatherPrometheusMetrics
				.Temperature
				.WithLabels("temp6", metrics.Mac ?? "none", metrics.StationType ?? "none")
		...
		if (metrics.Temp7F.HasValue)
		{
			AmbientWeatherPrometheusMetrics
				.Temperature
				.WithLabels("temp7", metrics.Mac ?? "none", metrics.StationType ?? "none")
		...
		if (metrics.Temp8F.HasValue)
		{
			AmbientWeatherPrometheusMetrics
				.Temperature
				.WithLabels("temp8", metrics.Mac ?? "none", metrics.StationType ?? "none")
		...
		if (metrics.Temp9F.HasValue)
		{
			AmbientWeatherPrometheusMetrics
				.Temperature
				.WithLabels("temp9", metrics.Mac ?? "none", metrics.StationType ?? "none")
		...
		if (metrics.Temp10F.HasValue)
		{
			AmbientWeatherPrometheusMetrics
				.Temperature
				.WithLabels("temp10", metrics.Mac ?? "none", metrics.StationType ?? "none")
		...
		if (metrics.PM_In_Temp.HasValue)
		{
			AmbientWeatherPrometheusMetrics
				.Temperature
				.WithLabels("pmIndoor", metrics.Mac ?? "none", metrics.StationType ?? "none")
		...
		if (metrics.SoilTemp1.HasValue)
		{
			AmbientWeatherPrometheusMetrics
				.Temperature
				.WithLabels("soilTemp1", metrics.Mac ?? "none", metrics.StationType ?? "none")
		...
		if (metrics.SoilTemp2.HasValue)
		{
			AmbientWeatherPrometheusMetrics
				.Temperature
				.WithLabels("soilTemp2", metrics.Mac ?? "none", metrics.StationType ?? "none")
		...
		if (metrics.SoilTemp3.HasValue)
		{
			AmbientWeatherPrometheusMetrics
				.Temperature
				.WithLabels("soilTemp3", metrics.Mac ?? "none", metrics.StationType ?? "none")
		...
		if (metrics.SoilTemp4.HasValue)
		{
			AmbientWeatherPrometheusMetrics
				.Temperature
				.WithLabels("soilTemp4", metrics.Mac ?? "none", metrics.StationType ?? "none")
		...
		if (metrics.SoilTemp5.HasValue)
		{
			AmbientWeatherPrometheusMetrics
				.Temperature
				.WithLabels("soilTemp5", metrics.Mac ?? "none", metrics.StationType ?? "none")
		...
		if (metrics.SoilTemp6.HasValue)
		{
			AmbientWeatherPrometheusMetrics
				.Temperature
				.WithLabels("soilTemp6", metrics.Mac ?? "none", metrics.StationType ?? "none")
		...
		if (metrics.SoilTemp7.HasValue)
		{
			AmbientWeatherPrometheusMetrics
				.Temperature
				.WithLabels("soilTemp7", metrics.Mac ?? "none", metrics.StationType ?? "none")
		...
		if (metrics.SoilTemp8.HasValue)
		{
			AmbientWeatherPrometheusMetrics
				.Temperature
				.WithLabels("soilTemp8", metrics.Mac ?? "none", metrics.StationType ?? "none")
		...
		if (metrics.SoilTemp9.HasValue)
		{
			AmbientWeatherPrometheusMetrics
				.Temperature
				.WithLabels("soilTemp9", metrics.Mac ?? "none", metrics.StationType ?? "none")
		...
		if (metrics.SoilTemp10.HasValue)
		{
			AmbientWeatherPrometheusMetrics
				.Temperature
				.WithLabels("soilTemp10", metrics.Mac ?? "none", metrics.StationType ?? "none")
	...
	public void ProcessUVIndex(AmbientWeatherMetricsPostRequest metrics)
	{
		if (metrics.UV.HasValue)
		{
			AmbientWeatherPrometheusMetrics
				.UVIndex
				.WithLabels("uv", metrics.Mac ?? "none", metrics.StationType ?? "none")
	...
	public void ProcessWindDirection(AmbientWeatherMetricsPostRequest metrics)
	{
		if (metrics.WindDir.HasValue)
		{
			AmbientWeatherPrometheusMetrics
				.WindDirection
				.WithLabels("wind", metrics.Mac ?? "none", metrics.StationType ?? "none")
		...
		if (metrics.WindGustDir.HasValue)
		{
			AmbientWeatherPrometheusMetrics
				.WindDirection
				.WithLabels("gust", metrics.Mac ?? "none", metrics.StationType ?? "none")
		...
		if (metrics.WindDir_Avg2m.HasValue)
		{
			AmbientWeatherPrometheusMetrics
				.WindDirection
				.WithLabels("2mAvg", metrics.Mac ?? "none", metrics.StationType ?? "none")
		...
		if (metrics.WindDir_Avg10m.HasValue)
		{
			AmbientWeatherPrometheusMetrics
				.WindDirection
				.WithLabels("10mAvg", metrics.Mac ?? "none", metrics.StationType ?? "none")
	...
	public void ProcessWindSpeed(AmbientWeatherMetricsPostRequest metrics)
	{
		...
		if (metrics.MaxDailyGust.HasValue)
		{
			AmbientWeatherPrometheusMetrics
				.WindSpeed
				.WithLabels("maxDailyGust", metrics.Mac ?? "none", metrics.StationType ?? "none")
